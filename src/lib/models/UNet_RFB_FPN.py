...
class UNet_RFB_FPN(Model):
    def __init__(self):
        super(UNet_RFB_FPN, self).__init__()
        ...
        self.side_conv_1 = Conv2D(512, 1, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_2 = Conv2D(256, 1, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_3 = Conv2D(128, 1, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_4 = Conv2D(64, 1, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_5 = Conv2D(32, 1, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
