...
class Attention_UNet(Model):
    def __init__(self):
        ...
        self.conv_r1 = Conv2D(512, 1, strides=1, kernel_initializer=initializer)
        ...
        self.conv_r2 = Conv2D(256, 1, strides=1, kernel_initializer=initializer)
        ...
        self.conv_r3 = Conv2D(128, 1, strides=1, kernel_initializer=initializer)
        ...
        self.conv_r4 = Conv2D(64, 1, strides=1, kernel_initializer=initializer)
        ...
        self.conv_r5 = Conv2D(32, 1, strides=1, kernel_initializer=initializer)
