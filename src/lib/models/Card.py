...
class CARD(Model):
    def __init__(self):
        ...
        self.layer_1_2 = self.WARB_block(64, 16, 3, initializer)
        self.layer_3_4 = self.WARB_block(64, 16, 3, initializer)
        self.layer_5_6 = self.WARB_block(64, 16, 3, initializer)
        self.layer_7_8 = self.WARB_block(64, 16, 3, initializer)
        self.layer_9_10 = self.WARB_block(64, 16, 3, initializer)
        self.layer_11_12 = self.WARB_block(64, 16, 3, initializer)
        self.layer_13_14 = self.WARB_block(64, 16, 3, initializer)
        self.layer_15_16 = self.WARB_block(64, 16, 3, initializer)
        self.layer_17_18 = self.WARB_block(64, 16, 3, initializer)
        self.layer_19_20 = self.WARB_block(64, 16, 3, initializer)
