...
class FPN_RFB_RefineDet(Model):
    def __init__(self):
        super(FPN_RFB_RefineDet, self).__init__()

        initializer = tf.keras.initializers.GlorotNormal(seed=0)
        self.max_pool = MaxPool2D(pool_size=(2, 2), strides=2, padding='same')
        self.upsample_2x = Conv2DTranspose(32, 4, activation='relu', strides=2, padding='same', kernel_initializer=initializer)
        self.upsample_4x = Conv2DTranspose(32, 4, activation='relu', strides=4, padding='same', kernel_initializer=initializer)
        self.upsample_8x = Conv2DTranspose(32, 4, activation='relu', strides=8, padding='same', kernel_initializer=initializer)
        self.upsample_16x = Conv2DTranspose(32, 4, activation='relu', strides=16, padding='same', kernel_initializer=initializer)

        self.up_1 = Conv2DTranspose(128, 4, activation='relu', strides=2, padding='same', kernel_initializer=initializer)
        self.up_2 = Conv2DTranspose(128, 4, activation='relu', strides=2, padding='same', kernel_initializer=initializer)
        self.up_3 = Conv2DTranspose(128, 4, activation='relu', strides=2, padding='same', kernel_initializer=initializer)
        self.up_4 = Conv2DTranspose(128, 4, activation='relu', strides=2, padding='same', kernel_initializer=initializer)
        ...
        self.side_conv_1_s = Conv2D(128, 3, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_2 = Conv2D(128, 3, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_2_s = Conv2D(128, 3, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_3 = Conv2D(128, 3, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_3_s = Conv2D(128, 3, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_4 = Conv2D(128, 3, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
        self.side_conv_4_s = Conv2D(128, 3, activation='relu', strides=1, padding='same', kernel_initializer=initializer)
